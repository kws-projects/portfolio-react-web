...
}[] = [
  {
    ...
    content: {
      ...
      ar: {
        ...
        description:
          'العمل على تطبيقات ويب على مستوى المؤسسات لعملاء في قطاعي البنوك والتأمين. بناء لوحات معلومات متجاوبة ودمج واجهات برمجة التطبيقات والمساهمة في مكونات نظام التصميم.',
        subItems: [
          {
            title: 'متدرب',
            tasks: [
              'المساهمة في تطوير الواجهة الأمامية باستخدام React و TypeScript',
              'تنفيذ مكونات واجهة المستخدم وإصلاح الأخطاء عبر مشاريع متعددة',
              'المشاركة في مراجعة الأكواد وتخطيط السبرينت',
            ],
          },
          {
            title: 'محلل',
            tasks: [
              'قيادة تطوير الواجهة الأمامية لمشاريع العملاء في البنوك والتأمين',
              'تصميم مكتبات مكونات قابلة لإعادة الاستخدام ورموز نظام التصميم',
              'تحسين خطوط الإنتاج وتقليل أوقات CI/CD بنسبة 40%',
              'توجيه المطورين المبتدئين وإجراء التأهيل التقني',
            ],
          },
        ],
      },
  ...
  },
  {
    ...
    content: {
      ...
      ar: {
        title: 'Lalamove',
        description:
          'بناء وصيانة ميزات شاملة لمنصة لوجستية تخدم ملايين المستخدمين عبر آسيا. العمل مع React و Node.js و Kotlin والبنية التحتية السحابية.',
        subItems: [
          {
            title: 'مهندس برمجيات شامل',
            tasks: [
              'تطوير ميزات شاملة عبر خدمات الويب والخلفية',
              'العمل مع بنية الخدمات المصغرة والأنظمة القائمة على الأحداث',
              'بناء وصيانة خطوط CI/CD ولوحات المراقبة',
              'المساهمة في موثوقية المنصة وتحسين الأداء',
            ],
          },
        ],
      },
