      ...
      <Section className="px-8 md:px-0 pt-4 md:pt-12" showBreakline={false}>
        <div>
          ...
          <p>
            ...
            conditions. Do not continue to use Kenneth Wong if you do not agree
          ...
          <p>
            We employ the use of cookies. By accessing Kenneth Wong, you agreed
            to use cookies in agreement with the Kenneth Wong's Privacy Policy.{' '}
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, Kenneth Wong and/or its licensors own the
            intellectual property rights for all material on Kenneth Wong. All
            intellectual property rights are reserved. You may access this from
            Kenneth Wong for your own personal use subjected to restrictions set
          ...
          <p>
            ...
            Kenneth Wong does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of Kenneth Wong,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws, Kenneth
            Wong shall not be liable for the Comments or for any liability,
          ...
          <p>
            Kenneth Wong reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant Kenneth Wong a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Kenneth Wong;
          ...
          <p>
            ...
            sending an e-mail to Kenneth Wong. Please include your name, your
          ...
          <p>
            No use of Kenneth Wong's logo or other artwork will be allowed for
