...
const Version = () => {
  return (
    <a
      className="group flex items-center gap-x-1.5 text-xs px-3 py-1.5 bg-surface-raised border border-border/10 rounded-lg cursor-pointer select-none hover:border-accent/30 transition-all duration-200"
